    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50">
          ...
          <div className="absolute right-0 top-0 h-full w-80 bg-white dark:bg-slate-900 shadow-2xl transform transition-transform duration-300 ease-in-out animate-in slide-in-from-right">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <Link
                      href="/"
                      onClick={() => setIsOpen(false)}
                      className="flex items-center space-x-4 p-4 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-all duration-200 group animate-in slide-in-from-right-4 fade-in duration-500 delay-100"
                    >
                      ...
                      <div className="flex-1">
                        <div className="font-semibold text-lg">All News</div>
                        <div className="text-sm text-slate-500 dark:text-slate-400">Latest crypto news from all categories</div>
                      </div>
                    </Link>
                    ...
                    <Link
                      href="/charts"
                      onClick={() => setIsOpen(false)}
                      className="flex items-center space-x-4 p-4 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-all duration-200 group animate-in slide-in-from-right-4 fade-in duration-500 delay-200"
                    >
                      ...
                      <div className="flex-1">
                        <div className="font-semibold text-lg">Charts</div>
                        <div className="text-sm text-slate-500 dark:text-slate-400">Crypto price charts and analysis</div>
                      </div>
                    </Link>
                    ...
                    <button
                      ...
                      className="w-full flex items-center space-x-4 p-4 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-all duration-200 group animate-in slide-in-from-right-4 fade-in duration-500 delay-300"
                    >
                      ...
                      <div className="flex-1">
                        <div className="font-semibold text-lg">{isDarkMode ? 'Light Mode' : 'Dark Mode'}</div>
                        <div className="text-sm text-slate-500 dark:text-slate-400">Toggle theme appearance</div>
                      </div>
                    </button>
                  </div>
                    ...
                    {categories.map((category, index) => {
                      ...
                      return (
                        <Link
                          ...
                          href={category.href}
                          onClick={() => setIsOpen(false)}
                          className={`flex items-center space-x-4 p-4 rounded-xl transition-all duration-200 group animate-in slide-in-from-right-4 fade-in duration-500 ${
                            isActive
